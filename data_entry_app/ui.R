      ...
      tabItem(
        ...
        fluidRow(
          ...
          column(width = 4,
                 ...
                 box(
                   width = NULL, title = "Surveillance Prioritization",
                   "Question 1 of 27",
                   id = "sur_pri",
                   bsCollapse(
                     id = "collapseExample",
          ...
          column(width = 4,
                 # Patrol Planning Box
                 box(
                   width = NULL, title = "Patrol Planning", "Question 2 of 27", id = "pat_pla",
                   bsCollapse(
                     id = "pat_pla_collapse",
                     open = "Panel 1",
                     bsCollapsePanel(
          ...
          column(width = 4,
                 box(
                   width = NULL, title = "Vessel Availability",
        ...
        fluidRow(
          ...
          column(width = 4,
                 box(
                   width = NULL, title = "Patrol Execution",
          ...
          column(width = 4,
                 ...
                 box(
                   width = NULL, title = "Fleet Adequacy", "Question 5 of 27", id = "fle_ade",
                   bsCollapse(
                     id = "fle_ade_collapse",
                     open = "Panel 1",
                     bsCollapsePanel(
          ...
          column(width = 4,
                 ...
                 box(
                   width = NULL, title = "Patrol Equipment", "Question 6 of 27", id = "pat_equ",
                   bsCollapse(
                     id = "pat_equ_collapse",
                     open = "Panel 1",
                     bsCollapsePanel(
        ...
        fluidRow(
          ...
          column(width = 4,
                 ...
                 box(
                   width = NULL, title = "Intelligence Sources", "Question 7 of 27", id = "int_sou",
                   bsCollapse(
                     id = "int_sou_collapse",
                     open = "Panel 1",
                     bsCollapsePanel(
          ...
          column(width = 4,
                 ...
                 box(
                   width = NULL, title = "Investigation Procedures", "Question 8 of 27", id = "inv_pro",
                   bsCollapse(
                     id = "inv_pro_collapse",
                     open = "Panel 1",
                     bsCollapsePanel(
          ...
          column(width = 4,
                 ...
                 box(
                   width = NULL, title = "Institutional Collaboration (National)", "Question 9 of 27", id = "nat_inst",
                   bsCollapse(
        ...
        fluidRow(
          ...
          column(width = 4,
                 box(
                   width = NULL, title = "Institutional Collaboration (International/Regional - if applicable)", "Question 10 of 27", id = "int_inst",
                   bsCollapse(
                 ...
                 ) # end Institutional Collaboration (Internationa
          ...
          column(width = 4,
                 ...
                 box(
                   width = NULL, title = "Staff Numbers", "Question 11 of 27", id = "sta_num",
                   bsCollapse(
                     id = "sta_num_collapse",
                     open = "Panel 1",
                     bsCollapsePanel(
